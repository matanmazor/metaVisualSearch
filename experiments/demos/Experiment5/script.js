...
const study = lab.util.fromObject({
  ...
  "plugins": [
    ...
    },
    {
      ...
      "filePrefix": "meta_vs_asymmetries",
      "path": undefined
    }
  ],
  "metadata": {
    "title": "meta_VS_asymmetries",
    "description": "",
    "repository": "https:\u002F\u002Fgithub.com\u002Fmatanmazor\u002Fmetavisualsearch",
    "contributors": "Matan Mazor\nMax Siegel\nJosh Tenenbaum"
  },
  "messageHandlers": {},
  "files": {},
  "responses": {},
...
if (this.state.correct & window.demoRT<2) {
  window.demoRTs.push(window.demoRT)
    ...
    },
    {
      ...
      "content": "\u003Cmain class=\"content-vertical-center content-horizontal-center\"\u003E\n  \u003Cdiv class=\"w-m text-justify\"\u003E\n    \u003Cp\u003E In each trial, you will estimate how long it will take you to find a target when mixed with other distractors presented in a square. Only the identity and number of distractors are relevant here, not their specific locations.\u003C\u002Fp\u003E\n    \u003Cp\u003EBe as accurate as possible.\u003C\u002Fp\u003E\n    \u003Cp\u003EIn the third part, you will perform these searching tasks (the same number and type of distractors, but ordered in a new, random way), and receive points only if you find the target as fast as your estimate, or faster. You will get more points if your estimate was that you will find the target quickly, and fewer points if you estimated that finding the target will take you long.\u003C\u002Fp\u003E\n     \u003Cp\u003ETo help you in your estimation, small black arrows will mark your search times from the first part of the experiment. \u003C\u002Fp\u003E\n    \n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E\n\n\u003Cfooter class=\"content-horizontal-right\"\u003E\n  \u003Cbutton id=\"continue\"\u003EContinue &rarr;\u003C\u002Fbutton\u003E\n\u003C\u002Ffooter\u003E"
    },
    {
      "type": "lab.canvas.Screen",
      "content": [
  ...
  return (p) => {
    ...
    p.draw = function() {
      ...
      if (mouseOverSlider()) {
        ...
        //draw bonus
        p.fill(0);
        p.ellipse(p.width*0.3, p.height*0.8-(0.6*bonus*p.height/57), 72, 72);
        p.fill(255);
        p.ellipse(p.width*0.3, p.height*0.8-(0.6*bonus*p.height/57), 70, 70);
        p.fill(0);
        p.textSize(28)
        // p.textStyle(p.BOLD);
        p.textFont("Permanent Marker");
        p.text(bonus.toFixed(1), p.width*0.3, p.height*0.8-(0.6*bonus*p.height/57))
      }
...
document.getElementById("feedback").innerHTML = feedback;
      ...
      "content": "\u003Cmain class=\"content-vertical-center content-horizontal-center\"\u003E\n  \u003Cdiv class=\"w-m text-justify\"\u003E\n    \u003Cp id = 'feedback'\u003EFor this first estimation, you estimated that it will take you \u003Cb\u003E_estimate_\u003C\u002Fb\u003E seconds to find 1 \u003Ci\u003ET\u003C\u002Fi\u003E among 3 randomly positioned rotated \u003Ci\u003EL\u003C\u002Fi\u003E's. \u003Cbr\u002F\u003E\n    If you will find the \u003Ci\u003ET\u003C\u002Fi\u003E in _estimate_ seconds or less in part 3 of the experiment, you will get \u003Cb\u003E_num_points_\u003C\u002Fb\u003E points. Otherwise, you will get zero points. Your final number of points will determine whether you get a bonus or not. \u003C\u002Fp\u003E\n    \u003Cp\u003EIn the next 12 trials you wil estimate how long it will take you to find different targets among different distractors.\u003C\u002Fp\u003E\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E\n\n\u003Cfooter class=\"content-horizontal-right\"\u003E\n  \u003Cbutton id=\"continue\"\u003EContinue &rarr;\u003C\u002Fbutton\u003E\n\u003C\u002Ffooter\u003E",
      "tardy": true
    },
    {
      "type": "lab.flow.Loop",
      ...
      "template": {
        ...
        "content": [
          ...
          },
          {
            ...
            "strokeWidth": 1,
            "fill": "black",
            "text": "How long (in seconds) will it take you to find the      \nwhen shuffled with this set of distractors?",
            "fontStyle": "normal",
            "fontWeight": "normal",
            "fontSize": "20",
            "fontFamily": "'Quicksand', sans-serif",
 ...
 const calculateBonus = function(x) {
  ...
  this.state.duration;
    ...
    },
    {
      ...
      "messageHandlers": {},
      "title": "Instructions3",
      "content": "\u003Cmain class=\"content-vertical-center content-horizontal-center\"\u003E\n  \u003Cdiv class=\"w-m text-justify\"\u003E\n  \u003Ch1\u003EPart 3\u003C\u002Fh1\u003E\n    \u003Cp\u003EYou finished the second part!\u003C\u002Fp\u003E\n    \u003Cp\u003EIn the third and last part of the experiment, you will perform five trials of each visual search task for which you gave a time estimate. Try to be as fast and accurate as possible, as your bonus depends on this! \n      Just like in the first part, there's no time pressure on pressing the number key, but only on pressing the \u003Ckbd\u003Espacebar\u003C\u002Fkbd\u003E.\u003C\u002Fp\u003E\n\n      \u003Cp\u003EThe target object will change once in every 5 searches, so pay attention to the instructions before each search.\u003C\u002Fp\u003E\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E\n\n\u003Cfooter class=\"content-horizontal-right\"\u003E\n  \u003Cbutton id=\"continue\"\u003EContinue &rarr;\u003C\u002Fbutton\u003E\n\u003C\u002Ffooter\u003E"
    },
    {
      "type": "lab.flow.Loop",
      "files": {},
...
window.counter+=1
window.skip = !([20,40].includes(window.counter));
}
              },
              "viewport": [
                800,
...
this.data.RT = window.RT;
this.data.bonus = window.bonus;
document.getElementById("bonus_msg").innerHTML = "You collected "+ String(Math.round(window.bonus))+ " points. We will double your payment if this is within the top 30% of our participants";
